...
# import always succeeds. ``Icons`` / ``Arrows`` are constructed inside
# core.py (they are Image instances), so they ship with the hardware
# import group too.
try:
...
if _HAS_HARDWARE:
    from .core import (  # noqa: F401
        Display, Image, Icons, Arrows, display, color, colorwheel,
