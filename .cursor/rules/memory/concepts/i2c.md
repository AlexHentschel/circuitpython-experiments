...
| Per-part powered-off-protection | per-device | "Supports I2C" ≠ "has powered-off protection." Confirm from the specific switch datasheet (TMUX1511/154E etc. list it explicitly; TS5A23166 does not behave on floating VDD). |
