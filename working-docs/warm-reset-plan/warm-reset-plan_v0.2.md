# Warm-Reset Execution Plan — v0.2

**Status**: draft (v0.2; iteration 2 of the `_META.md` loop). **Authored**: 2026-06-14. **Consumer**: AI now; Alex at sign-off. **Loop governance**: `_META.md` (same folder). **Changes v0.1→v0.2**: see `notes_v0.2.md` (added S7 retrieval-acceptance tests, refined C7's provisional watch-for to carry confirm/refute/trigger, relabelled D4/D5 to Recon-A/Recon-B to remove the R1/R2 review-step collision, CONTEXT.md reference-don't-duplicate note). Prior: `notes_v0.1.md`.
