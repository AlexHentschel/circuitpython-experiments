...
| Git history/publishing hygiene (scrub, PR-ref persistence, attribution/licensing) | coding-tutor | `concepts/git.md` (mechanics); `crossref/BY_PATTERN.md` (attribution workflow candidate); trail in `projects/coding-tutor/SESSION_LOG.md` | Verified 2026-07-15 on a real public repo. Pull before re-deriving how to remove/attribute third-party content in a published repo. |
