...
| `circuitpython-exp16-planetx` | Exp16 BPI-Bit-S2 CircuitPy PlanetX + LED | `circuitpython` | `2026-09_Exp16_*/**` | `projects/circuitpython-exp16-planetx/` | P6 host-green; P7/P8 pending | 2026-09-04 | LightTower PoC. Overnight P1–P6 done 2026-09-04. Board unplugged until P8. **Isana LightTower folder is read-only reference.** |
