...
| `circuitpython-exp16-planetx` | Exp16 BPI-Bit-S2 CircuitPy PlanetX + LED | `circuitpython` | `2026-09_Exp16_*/**` | `projects/circuitpython-exp16-planetx/` | P6 host-green; P7/P8 pending | 2026-09-11 | LightTower PoC. UID `0740D10F1BE9` now CP **10.3.0** (Path A; TinyUF2 0.35.0). Other boards not assumed. **Isana LightTower folder is read-only reference.** |
