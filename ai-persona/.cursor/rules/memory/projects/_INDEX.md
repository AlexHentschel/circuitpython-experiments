...
| `circuitpython-exp16-planetx` | Exp16 BPI-Bit-S2 CircuitPy PlanetX + LED | `circuitpython` | `2026-09_Exp16_*/**` | `projects/circuitpython-exp16-planetx/` | active (P1–P6 executing) | 2026-09-04 | LightTower PoC. P0 done. Overnight host P1–P6 kickoff authorized 2026-09-04. Board unplugged until P8. **Isana LightTower folder is read-only reference.** |
