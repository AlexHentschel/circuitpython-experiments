...
| `circuitpython-exp16-planetx` | Exp16 BPI-Bit-S2 CircuitPy PlanetX + LED | `circuitpython` | `2026-09_Exp16_*/**` | `projects/circuitpython-exp16-planetx/` | first milestone on-device (K1/K2/K3); font Phase 4 landed, Phase 5 on-device | 2026-09-20 | LightTower PoC. UID `0740D10F1BE9` CP **10.3.0** (Path A; TinyUF2 0.35.0). Other boards not assumed. **Isana LightTower folder is read-only reference.** |
