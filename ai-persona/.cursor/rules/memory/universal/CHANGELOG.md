...
- New `projects/ai-tooling/{CONTEXT,SESSION_LOG}.md` (family `meta`; provisional) — workstream home for persona self-improvement + AI tooling. `CONTEXT.md § Entry points` references the launcher prompt `ai-persona/ai-notes/2026-09_CPy-full_memory_lifecycle/2026-09_full_memory_lifecycle_prompt.md` (gitignored) + the read-only HA method/harness source. Roster row + path-globs (`ai-persona/**`) added to `projects/_INDEX.md`. (commit `f4608f8`)
