# Execution plan v0.3 — Exp16 first milestone (overnight PoC)

**Status:** refinement 3 (extractor merge). **Date:** 2026-09-04. **Loop:** cap 8; sign-off = `plan_v1.0.md`.
...
Cadence (import, do not copy): [`reflection-cadence.md`](reflection-cadence.md). Rubric: [`../design/student-api-portability.md`](../design/student-api-portability.md) (re-open **G1–G7 and A1–A4** at P-phase). Digests: [`../digests/INDEX.md`](../digests/INDEX.md). Notes: [`notes_v0.3.md`](notes_v0.3.md). Loop lock: [`loop-setup.md`](loop-setup.md) (cap 8, sub-agents authorized).
